    ...
    public partial class InitialFiles : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SharedPantries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SharedPantries_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SharedPantryId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Products_SharedPantries_SharedPantryId",
                        column: x => x.SharedPantryId,
                        principalTable: "SharedPantries",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_SharedPantryId",
                table: "Products",
                column: "SharedPantryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SharedPantries_UserId",
                table: "SharedPantries",
                column: "UserId");
